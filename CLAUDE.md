...
10. **Minimal changes only**. When bumping versions, the new ebuild should be identical to the old one unless upstream changes require modifications. Do NOT reformat, reorder, or "improve" existing ebuilds during version bumps.
